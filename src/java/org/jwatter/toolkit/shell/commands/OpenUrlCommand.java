...
public class OpenUrlCommand extends AbstractCommand implements Command
{
	protected BrowserController controller;

	public OpenUrlCommand ( BrowserController controller )
	{
		super(new String[]
		{
				"o", "open"
		...
		{
			"url"
		}, new String[0], "open a url in the current browser");
	...
	public void execute ( String... args ) throws CommandExecutionException
	{
		try
		{
			controller.send(new OpenUrlRequest(args[0]));
		}
