...
public class BrowserHistoryForwardCommand extends AbstractCommand implements
																	Command
{
	protected BrowserController browserController;

	public BrowserHistoryForwardCommand ( BrowserController browserController )
	{
		super(new String[]
		{
				"n", "forward"
	...
	public void execute ( String... args ) throws CommandExecutionException
	{
		try
		{
			browserController.send(new BrowserNavigationRequest(
					BrowserNavigationRequest.FORWARD));
		}
